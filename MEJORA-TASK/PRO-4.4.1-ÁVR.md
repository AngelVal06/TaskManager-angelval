...
/**
 * Servicio principal para la gestión de actividades (tareas y eventos).
 * Proporciona funcionalidades para agregar, listar, filtrar y modificar actividades,
 * así como para gestionar subtareas y generar resúmenes.
 *
 * @property consola Interfaz de usuario para interacción con el usuario
 * @property repo Repositorio de actividades
 * @property servicioUsuario Servicio para gestión de usuarios
 * @property historial Controlador para registro de historial
 * @property logger Logger para registro de eventos
 */
class ActividadService {
    ...
    /**
     * Gestiona el programa principal mostrando el menú y procesando las opciones seleccionadas.
     * Maneja excepciones globales y registra errores inesperados.
     */
    ...
    /**
     * Agrega una subtarea a una tarea existente.
     *
     * @throws NumberFormatException Si el ID de la tarea madre no es un número válido
     * @throws IllegalStateException Si no se encuentra la tarea madre
     */
    ...
    /**
     * Filtra actividades según un criterio especificado.
     *
     * @param condicion Función lambda que define el criterio de filtrado
     */
    ...
    /**
     * Muestra un resumen estadístico de las actividades:
     * - Total de tareas y eventos
     * - Actividades para hoy, mañana, esta semana y este mes
     */
    private fun resumen() {
